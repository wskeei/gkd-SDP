...
internal fun HistoryRow(record: UsageGuardRecord, appName: String) {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
        ...
        Text(
            stringResource(
                R.string.s_d159fb78f0,
                record.requestedDurationMinutes.toString(),
                formatDurationLocalized(
                    UsageGuardReviewPolicy.effectiveUsedSeconds(record) * 1_000L,
                ),
            ),
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        ...
        Text(
            stringResource(record.endStateTextRes()),
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
    }
