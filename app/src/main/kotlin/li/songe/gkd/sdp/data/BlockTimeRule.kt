...
data class BlockTimeRule(
    ...
    fun formatModeDescription(context: Context): String =
        context.getString(if (isAllowMode) R.string.time_allow_period else R.string.time_forbid_period)
    ...
    interface BlockTimeRuleDao {
        ...
        @Query("DELETE FROM block_time_rule")
