...
class ReviewDashboardFlowTest {
    ...
    @Test
    fun reviewDashboardIsReachableFromSelfControl() {
        composeRule.onNodeWithTag("nav_self_control", useUnmergedTree = true).performClick()
        composeRule.onNodeWithTag("self_control_review").performClick()
        composeRule.onNodeWithTag("usage_guard_review_title").assertExists()
    }
}
