...
- 首页固定为“概览 / 自律 / 规则 / 设置”四个一级入口；紧凑宽度使用底部导航，中等及扩展宽度使用左侧导航栏。
- 首次启动和权限修复统一进入“运行能力中心”，按顺序展示无障碍/Automation、悬浮窗、通知、电池优化和 Shizuku 状态与唯一下一步操作。
- 设置页支持中文/英文关键词搜索，并提供“隐私与数据”入口查看本地保留范围、删除历史记录、生成加密备份或白名单支持包。
...
- 提供申请复盘页和桌面小组件，查看近 24 小时、近 7 天、近 30 天申请模式。
...
- 复盘按“使用申请/拦截”主类型、近 24 小时/近 7 天/近 30 天滚动范围组织。
